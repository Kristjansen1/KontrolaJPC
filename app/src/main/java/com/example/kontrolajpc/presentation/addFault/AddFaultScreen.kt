...
fun AddErrorScreen(
    ...
    //val c = x.showEditFaultIconId
    //applog("viewmodel","viewmodel5555 selection state ${x.showEditFaultIconId}")

    //applog("viewmodel",selectionState.showEditFaultIconId.toString())
        ...
        Column(
            ...
            OutlinedTextField(
                ...
                modifier = Modifier
                    ...
                    .fillMaxWidth(),
                value = DateUtil.fromLongToDate(state.date,Const.DATE_FORMAT_UI),
                onValueChange = {},
                trailingIcon = {
                    Icon(
                        ...
                        Modifier.clickable(
                            onClick = {
                                ...
                                //onEvent(FaultEvent.NekiNeki(4))
                                //applog("viewmodel","viewmodel32 selection state ${c}")
                                //applog("viewmodel",selectionState.showEditFaultIconId.toString())
            ...
            Tfield(label = "Posel", value = state.posel, onValueChange = {
                //applog("viewmodel","viewmodel32 selection state ${x.showEditFaultIconId}")
                //applog("viewmodel",selectionState.showEditFaultIconId.toString())
